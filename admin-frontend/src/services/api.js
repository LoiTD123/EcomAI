...
export const authAPI = {
  ...
  updateUserRole: (userId, role) => api.put('/api/v1/auth/users', { user_id: userId, role }),
};
...
export const orderAPI = {
  ...
  updateStatus: (id, status, comment) => api.post(`/api/v1/orders/${id}/status`, { status, comment }),
};

export const shippingAPI = {
  list: () => api.get('/api/v1/shipping/'),
  updateTracking: (data) => api.post('/api/v1/shipping/tracking', data),
  complete: (data) => api.post('/api/v1/shipping/complete', data),
};
